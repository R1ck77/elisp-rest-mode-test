...
(defun rest-expand--replace-header (new-header)
  (let ((point (point)))
...
(defun rest-expand--expand-text ()
  ...
  (let* ((contents (rest-expand--get-expanded-content))
    ...
    (with-silent-modifications
      (save-excursion
        (rest-expand--replace-header expanded-headline)
...
(defun rest-expand--collapse-text ()
  ...
  (let* ((contents (rest-expand--get-expanded-content))
         (collapsed-header (car contents))
    (with-silent-modifications
             (save-excursion
               (rest-expand--replace-header collapsed-header)
               (forward-line)
